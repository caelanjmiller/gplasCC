...
path_init_nodes <- "./test_run_R/coverage/ecoli_repeat_nodes.tab"
path_cov_variation <- "./test_run_R/coverage/ecoli_estimation.txt"
input_solutions <- "./test_run_R/walks/repeats/ecoli_solutions.csv" #NEW
classifier <- "predict"
threshold <- "0.95"
iterations <- "20"
modularity_threshold <- "0.2"
path_bins <- "./test_run_R/results/ecoli_results_no_repeats.tab" #NEW
clean_repeats_path<- "./test_run_R/coverage/ecoli_clean_repeats.tab" #NEW
bold_sd_coverage <- "2"
...
suppressWarnings(write.table(x = full_info_assigned, file = "./test_run_R/results/ecoli_results.tab", append = TRUE, row.names = FALSE, quote = FALSE, col.names = TRUE))
suppressWarnings(write.table(x = results_summary, file = "./test_run_R/results/ecoli_bins.tab", append = TRUE, row.names = FALSE, quote = FALSE, col.names = TRUE))

#format chromosome repeats and print
chromosome_repeats<-chromosome_repeats[,c(2,1)]
chromosome_repeats$Bin<-'Chromosome'
suppressWarnings(write.table(x = chromosome_repeats, file = "./test_run_R/results/ecoli_chromosome_repeats.tab", append = TRUE, row.names = FALSE, quote = FALSE, col.names = TRUE))
