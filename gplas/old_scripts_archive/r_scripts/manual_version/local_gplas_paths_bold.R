...
filtering_threshold <- as.numeric(as.character("0.1"))
...
output_path <- "./test_run_R/walks/bold_mode/ecoli_solutions_bold.csv"
output_connections <- "./test_run_R/walks/bold_mode/ecoli_connections_bold.tab"
