...
#Outputs
output_path = "test_run\\walks\\repeats\\ecoli_solutions.tab"
output_connections = "test_run\\walks\\repeats\\ecoli_connections.tab"
...
#TODO not sure if sys.exit() works to exit the whole workflow
...
#TODO why is classificatioin != "Plasmid" also here?; why run this if not plasmid but len = 1??; change OR to AND?
...
#TODO base probs is now 0.5 check if this is 'allowed' or if something needs to change
...
#TODO why do we check for plasmid here?
