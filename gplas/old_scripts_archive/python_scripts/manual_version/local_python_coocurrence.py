...
input_solutions = "test_run\\walks\\normal_mode\\ecoli_solutions.tab"
...
output_png = "test_run\\results\\normal_mode\\ecoli_plasmidome_network.png"
...
#can we use lowercase 'bin'?
    ...
    pl_unbinned.to_csv("test_run\\results\\normal_mode\\ecoli_results_no_repeats.tab", sep="\t", index=False, header=True, mode="w")
    results_subgraph.to_csv("test_run\\results\\normal_mode\\ecoli_bins_no_repeats.tab", sep="\t", index=False, header=True, mode="w")
...
#TODO unhardcode these filenames
full_info_assigned.to_csv("test_run\\results\\normal_mode\\ecoli_results_no_repeats.tab", sep="\t", index=False, header=True, mode="a")
results_subgraph.to_csv("test_run\\results\\normal_mode\\ecoli_bins_no_repeats.tab", sep="\t", index=False, header=True, mode="a")
